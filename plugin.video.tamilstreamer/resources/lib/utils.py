...
def color_movie_name(movie_name):
    movie_name = re.sub(r'\sHDRip|\sHD', ' [B][COLOR green] HD [/COLOR][/B]', movie_name)
    movie_name = re.sub(r'\sCAM', ' [B][COLOR cornflowerblue] CAM [/COLOR][/B]', movie_name)
    movie_name = re.sub(r'\sDVDScr', ' [B][COLOR skyblue] DVDScr [/COLOR][/B]', movie_name)
    movie_name = re.sub(r'\sDVDRip', ' [B][COLOR skyblue] DVDRip [/COLOR][/B]', movie_name)
